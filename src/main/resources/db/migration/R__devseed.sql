...
INSERT INTO flight_assessment(id, candidate_number,  instructor_id, insurance, logged_hours, suas_category, assessment_pass_date) VALUES(3, 'ASG-001-18-11', 1, true, 226, '40kg Rotor', '2018/12/2');
INSERT INTO flight_assessment(id, candidate_number,  instructor_id, insurance, logged_hours, suas_category, assessment_pass_date) VALUES(4, 'ASG-002-18-11', 2, true, 225, '40kg Rotor', '2018/12/2');
INSERT INTO flight_assessment(id, candidate_number,  instructor_id, insurance, logged_hours, suas_category, assessment_pass_date) VALUES(5, 'ASG-003-18-11', 1, true, 224, '40kg Rotor', '2018/12/2');
