INSERT INTO user (email, password, role, activated) VALUES ('admin@asg.com', '$2a$10$6443CNhV26R6qEMohATMYuleZxiUfr/ya0urCUqheo5STYOU6maqu', 'admin', 1),
                                                ('admin2@asg.com', '$2a$10$cGXMmSfOg2ZrUXUgCxaiaO4pgjJsSvcFYlKPMcFDBgVp3MqrZ2M96', 'admin', 1),
                                                ('client@asg.com', '$2a$10$S4MOcUgShERWJpI1EpTReeNbwKL09wElxbCLLimHdf3yrOG7H2PWG', 'candidate', 1),
                                                ('client2@asg.com', '$2a$10$uzGe/I2v.1LtdTPBQg8oDOe/07mlgaGyG0UoF8G5VQD7b6PAvTQHq', 'candidate', 1),
                                                ('client3@asg.com', '$2a$10$H2GWvDnlRJD1DuVPkfkSLujsmzSwGmM7ELKpZY0olKQFObp4GWZ56', 'candidate', 1),
                                                ('client4@asg.com', '$2a$10$1XELQEuTrZ0JbFg0MijjI.4QFWJYMppieYp5XN8Aj6z6LIg9QwgN2', 'candidate', 1);
...
INSERT INTO candidate (reference_number, user_id, first_name, surname, contact_info_id, general_info_id) VALUES ('ASG-001-18-11', 'client@asg.com', 'Blaise', 'Pascal', 1, 1);
INSERT INTO candidate (reference_number, user_id, first_name, surname, contact_info_id, general_info_id) VALUES ('ASG-002-18-11', 'client2@asg.com', 'Caroline', 'Herschel', 2, 2);
INSERT INTO candidate (reference_number, user_id, first_name, surname, contact_info_id, general_info_id) VALUES ('ASG-003-18-11', 'client3@asg.com', 'Edmond', 'Halley', 3, 3);
INSERT INTO candidate (reference_number, user_id, first_name, surname, contact_info_id, general_info_id) VALUES ('ASG-001-18-12', 'client4@asg.com', 'Enrico', 'Fermi', 4, 4);

INSERT INTO instructor (id, user_id, first_name, surname) VALUES (1, 'admin@asg.com', 'Erwin', 'Schroedinger');
INSERT INTO instructor (id, user_id, first_name, surname) VALUES (2, 'admin2@asg.com', 'Johannes', 'Kepler');
...
INSERT INTO flight_assessment(id, candidate_number,  instructor_id, insurance, logged_hours, suas_category, assessment_pass_date) VALUES(6, 'ASG-001-18-12', 2, true, 232, 'dsunno', NOW());
