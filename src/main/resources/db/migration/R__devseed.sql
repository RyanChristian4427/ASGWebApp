INSERT INTO user (email, password, first_name, surname, role, activated)
VALUES ('admin@asg.com', '$2a$10$6443CNhV26R6qEMohATMYuleZxiUfr/ya0urCUqheo5STYOU6maqu', 'Erwin', 'Schroedinger', 'admin', 1),
...
INSERT INTO address (id, line_1, line_2, city, postcode)
VALUES (1, 'Studio 103, The Business Centre', '61 Wellfield Road', 'Cardiff', 'CF24 3DG'),
...
INSERT INTO contact_info (id, phone_number, address_id)
VALUES (1, '7911123456', 1),
       (2, '7597268597', 2),
       (3, '7911123456', 3),
       (4, '7911564856', 4);
...
INSERT INTO general_info (id, date_of_birth, place_of_birth, company_name, previous_flying_exp, preferred_location, drone_type_id, english_speaking, disability, paid)
VALUES (1, '1990-2-28', 'Cardiff', '', 'None', 'Cardiff', 1, 5, 'none', 1),
       (2, '1990-10-21', 'Somerset', '', 'Some', 'Somerset', 2, 5, 'none', 1),
       (3, '1990-12-31', 'Aberdeen', 'Microsoft', 'A lot', 'Aberdeen', 1, 5, 'none', 1),
...
INSERT INTO flight_assessment(id, candidate_number,  instructor_id, insurance, logged_hours, suas_category, assessment_pass_date)
VALUES (3, 'ASG-001-18-11', 1, true, 226, '40kg Rotor', '2018/12/2'),
       (5, 'ASG-003-18-11', 1, true, 224, '40kg Rotor', '2018/12/2');
